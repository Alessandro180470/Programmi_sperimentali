...
def calcola_valore_maggiore_minore_differenza():
    val_max = max(analisi.ck, analisi1.ck, analisi2.ck)
    val_min = min(analisi.ck, analisi1.ck, analisi2.ck)
    diff = val_max - val_min
    print(f'Il valore massimo riscontrato del CK rilevato nelle analisi è: {val_max}')
    print(f'Mentre il valore minimo riscontrato è: {val_min}')
    print(f'La differenza tra il valore max e il min è di {diff}')
